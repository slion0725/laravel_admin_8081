...
$(function () {
    ...
    $('#Edit').on('click', function () {
        ...
        $('#Edit-Form').trigger('reset').data('formValidation').resetForm();
        $('#Edit-Form [name="accounts[]"], #Edit-Form [name="menuitems[]"]').multiselect('refresh');
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                if (data.status === true) {
                    ...
                    vars.select.map(function (v, i) {
                        $('#Edit-Form [name="' + v).multiselect('select', data.data[v]);;
                    });
